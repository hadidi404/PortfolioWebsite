      ...
      >
        ...
        <div className="flex flex-col items-center justify-center space-y-6">
          ...
          <div className="flex flex-col items-center space-y-2">
            ...
            <h2 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent animate-gradient pb-1">
              Rayson Barnachia
            </h2>

            <h3 className="text-3xl md:text-5xl text-gray-300">
              I build{' '}
          ...
          {/* GitHub */}
            <a
              ...
              target="_blank"
              className="p-3 rounded-full border border-gray-600 hover:border-gray-400 hover:text-gray-400 transition"
            >
              <svg
          ...
          <a
            ...
            target="_blank"
            className="p-3 rounded-full border border-gray-600 hover:border-blue-500 hover:text-blue-500 transition"
          >
             <svg
               xmlns="http://www.w3.org/2000/svg"
               className="w-6 h-6"
          ...
          <a
            ...
            className="p-3 rounded-full border border-gray-600 hover:border-red-500 hover:text-red-500 transition"
          >
             <svg
               xmlns="http://www.w3.org/2000/svg"
               className="w-6 h-6"
